...
class GeolocationService {
  Future<PotholeAddress> fetchPotholeAddress(PotholeCoordinates coordinates) async {
    
    String getLink = "https://maps.googleapis.com/maps/api/geocode/json?latlng=" + coordinates.latitude.toString() + "," + coordinates.longitude.toString() + "&key=AIzaSyC38yB81u25a2vvtsJGvGoWd6weOGaPx1A";
